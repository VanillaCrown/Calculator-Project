...
class Calculator {
    // constructor method for calculator class
      constructor() {
        ...
        //default values for the current and previous
    ...
    // clear the calculator
      ...
      //append a new number to the current operand (method)
      appendNumber(number) {
        //duplicate decimal points check
        ...
        if (this.currentOperand === "0" && number !== ".") {
          ...
          //new number to the current operand
          this.currentOperand += number
        }
      }
      ...
      chooseOperation(operation) {
        ...
        // new operation and move current to end
    ...
    // event listeners for each button to update the calculator display based on user input
